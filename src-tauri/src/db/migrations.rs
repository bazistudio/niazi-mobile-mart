...
pub const MIGRATIONS: &[Migration] = &[
    ...
    Migration {
        version: 14,
        name: "014_master_data_foundation",
        up: r#"
        ...
        INSERT OR IGNORE INTO companies (id, name, code, description, is_active, created_at, updated_at) VALUES
        ...
        INSERT OR IGNORE INTO qualities (id, name, code, description, is_active, created_at, updated_at) VALUES
        ...
        INSERT OR IGNORE INTO colors (id, name, code, description, is_active, created_at, updated_at) VALUES
